    ...
    while not done:
      ...
      if max_key != -1:
        for group in groups[max_key]:
          ...
          for jdx in [x for x in self.neighbors[group[0]] if x > max(group)]:
            how_many=0
            for x in group:
              if x < jdx:
...
if __name__=='__main__':
  primary = [[0, 1, 2, 3], [1, 0, 2, 3, 4], [2, 1, 0, 3], [3, 1, 4, 0, 2, 5], [4, 3, 5, 1, 6], [5, 4, 6, 3], [6, 5, 4]]
  overlaps_ = [[0, 1, 2, 3], [1, 0, 2, 3], [1, 0, 2, 3, 4], [3, 1, 4, 5], [4, 3, 5, 6], [5, 4, 6]]
